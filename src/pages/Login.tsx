    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: 32, fontWeight: 700, color: C.text, margin: 0, letterSpacing: 1 }}>
            AdsAI
          </h1>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: C.text2, letterSpacing: 0.5, display: 'block', marginBottom: 8 }}>
                HASŁO DOSTĘPU
              </label>
            ...
            <button type="submit" disabled={loading || !password} style={{
              ...
              background: password ? `linear-gradient(135deg, ${C.accent}, ${C.blue})` : C.subtle,
              border: 'none', borderRadius: 10, color: '#fff',
              fontFamily: 'Rajdhani, sans-serif', fontSize: 15, fontWeight: 700, letterSpacing: 0.5,
              cursor: password ? 'pointer' : 'default',
              boxShadow: password ? `0 4px 20px ${C.glow}` : 'none',
              transition: 'all .15s',
            }}>
          ...
          <div style={{ marginTop: 16, padding: '10px 12px', background: C.c2, borderRadius: 8, border: `1px solid ${C.border}` }}>
            <p style={{ fontSize: 11, color: C.text3, margin: 0, lineHeight: 1.5 }}>
              <strong style={{ color: C.orange }}>DEMO:</strong> Wpisz dowolne hasło (min. 4 znaki). Aplikacja działa na przykładowych danych Google Ads.
            </p>
          </div>
        </div>
      </div>
